...
SELECT `Entry`, `Item`, `Reference`, `Chance`, `QuestRequired`, `LootMode`, `GroupId`, `MinCount`, `MaxCount`, `Comment`, 12 AS `MinPatch`, 21 AS `MaxPatch` FROM `base_world`.`pickpocketing_loot_template` WHERE `Item` IN (
