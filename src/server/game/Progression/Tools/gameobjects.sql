...
UNION SELECT `guid`, `id`, `map`, `zoneId`, `areaId`, `spawnMask`, `phaseMask`, `position_x`, `position_y`, `position_z`, `orientation`, `rotation0`, `rotation1`, `rotation2`, `rotation3`, `spawntimesecs`, `animprogress`, `state`, `ScriptName`, `VerifiedBuild`, `Comment`, 13 AS `MinPatch`, 21 AS `MaxPatch` FROM `base_world`.`gameobject` WHERE `id` IN (185491, 185492, 185493, 185494, 185495, 185503, 185504, 185518, 185550)
