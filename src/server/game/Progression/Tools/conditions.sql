...
SELECT `sourceType`, `entry`, `flags`, `params_0`, `params_1`, `comment`, 20 AS `MinPatch`, 21 AS `MaxPatch` FROM `base_world`.`disables` WHERE `sourceType`=1 AND `entry` IN (550, 6145, 6521, 6522)
UNION SELECT `sourceType`, `entry`, `flags`, `params_0`, `params_1`, `comment`, 17 AS `MinPatch`, 21 AS `MaxPatch` FROM `base_world`.`disables` WHERE `sourceType`=1 AND `entry` IN (3631, 4487, 4488, 4489, 4490);
