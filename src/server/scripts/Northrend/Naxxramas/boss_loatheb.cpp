...
enum Events
{
    ...
    EVENT_CORRUPTED_MIND                        = 8,
    EVENT_REMOVE_CURSE                          = 9
};
...
public:
    ...
    struct boss_loathebAI : public BossAI
    {
        ...
        void JustEngagedWith(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_SUMMON_SPORE, sProgression->GetPatchId() < PATCH_ECHOES_OF_DOOM ? 13000 : 15000);
            if (pInstance)
            {
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                case EVENT_SUMMON_SPORE:
                    ...
                    events.RepeatEvent(sProgression->GetPatchId() < PATCH_ECHOES_OF_DOOM ? 13000 : 35000);
                    break;
                ...
                case EVENT_DEATHBLOOM:
                    if (sProgression->GetPatchId() < PATCH_ECHOES_OF_DOOM)
                    {
                        me->CastSpell(me, SPELL_DEATHBLOOM_10, false);
                    }
                    else
                    {
                ...
                case EVENT_INEVITABLE_DOOM:
                    if (sProgression->GetPatchId() < PATCH_ECHOES_OF_DOOM)
                    {
                        me->CastSpell(me, SPELL_INEVITABLE_DOOM_10, false);
                    }
                    else
                    {
                ...
                case EVENT_CORRUPTED_MIND:
                    me->CastSpell(me, SPELL_CORRUPTED_MIND, false);
                    events.Repeat(10s);
                    break;
                case EVENT_REMOVE_CURSE:
                    me->CastSpell(me, SPELL_REMOVE_CURSE, false);
                    events.Repeat(30s);
                    break;
            }
